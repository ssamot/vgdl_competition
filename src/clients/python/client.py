...
def queryStateAction(state_str,action):
    action_map = {}; action_map["action"] = action
    sys.stdout.write ("1" + json.dumps(action_map) + ";"  + state_str  + os.linesep);sys.stdout.flush()
...
if __name__=="__main__":
    ...
    while(line !=""):
        ...
        if(i ==0):
            ...
            sys.stdout.write ("0" + json.dumps(action_map) + os.linesep);sys.stdout.flush()
